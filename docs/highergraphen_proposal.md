...
members = [
  ...
  "crates/higher-graphen-structure",
  "crates/higher-graphen-projection",
  "crates/higher-graphen-evidence",
  "crates/higher-graphen-reasoning",
...
### 7.2 `higher-graphen-structure::space`
...
### 7.3 `higher-graphen-structure::morphism`
...
### 7.4 `higher-graphen-structure::context`
...
### 7.5 `higher-graphen-reasoning::invariant`
...
### 7.6 `higher-graphen-reasoning::obstruction`
...
### 7.7 `higher-graphen-reasoning::completion`
