...
| [`specs/intermediate-tools/casegraphen.md`](specs/intermediate-tools/casegraphen.md) | Points to the canonical CaseGraphen contract in the extracted repository. |
| [`specs/intermediate-tools/casegraphen-workflow-reasoning-engine.md`](specs/intermediate-tools/casegraphen-workflow-reasoning-engine.md) | Points to the canonical workflow reasoning engine specification in the extracted repository. |
| [`specs/intermediate-tools/casegraphen-current-surface-inventory.md`](specs/intermediate-tools/casegraphen-current-surface-inventory.md) | Points to the canonical CaseGraphen surface inventory in the extracted repository. |
| [`specs/intermediate-tools/casegraphen-workflow-contracts.md`](specs/intermediate-tools/casegraphen-workflow-contracts.md) | Points to the canonical CaseGraphen workflow contracts in the extracted repository. |
| [`specs/intermediate-tools/casegraphen-feature-completion-contract.md`](specs/intermediate-tools/casegraphen-feature-completion-contract.md) | Points to the canonical CaseGraphen feature completion contract in the extracted repository. |
| [`specs/intermediate-tools/casegraphen-native-case-management.md`](specs/intermediate-tools/casegraphen-native-case-management.md) | Points to the canonical native CaseGraphen case-management specification in the extracted repository. |
